...
* useRouteMatch matches the current url location, this makes it easier to route without excessive text and matching by hand

2. How would you explain form validation to someone who has never programmed before?

* form validation is a method that requires a user to meet a certain requirement in order to submit a form

3. In 1-2 sentences, define end to end testing.

* end to end testing checks the functionality of every part of a website to make sure that it is functioning properly
